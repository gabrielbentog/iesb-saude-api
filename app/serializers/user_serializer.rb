class UserSerializer < BaseSerializer
  attributes :id, :name, :email, :cpf, :phone, :avatar_url, :registration, :college_location_id, :semester, :registration_code, :created_at, :updated_at, :profile, :theme_preference
